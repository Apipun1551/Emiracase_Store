...
<html lang="en" dir="ltr">
	...
	<script>
        //notif konfirmasi hapus data
		$(".delete").on("submit", function () {
			return confirm("Yakin ingin menghapus?");
		});
        //Membuat form dengan configurable/simple dinamis
		function showHideConfigurableAttributes() {
			var productType = $(".product-type").val();
            //ketika configurable maka class attribute  yang configurable di munculkan
			if (productType == 'configurable') {
				$(".configurable-attributes").show();
			} else {//selebihnya di sembunyikan
